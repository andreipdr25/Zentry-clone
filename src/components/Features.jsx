...
const BentoCard = ({ src, title, description }) => {
    return (
        <div className="relative size-full">
            ...
            />
            <div className="relative z-10 lext size-full flex-col justify-between p-5 text-blue-50">
                <div>
        ...
        <section className="bg-black pb-52">
            <div className='container mx-auto px-3 md:px-10'>
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">Immerse yourself in an IP-rich product universe where players, agentic AI and blockchain lead the new economic paradigm.</p>
                </div>
